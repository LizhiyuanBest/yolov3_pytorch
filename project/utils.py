...
def select_best_evolve(path='../../Downloads/evolve*.txt'):  # from project.project import *; select_best_evolve()
...
def kmeans_targets(path='./data/coco_64img.txt'):  # from project.project import *; kmeans_targets()
    with open(path, 'r') as f:
...
def plot_results(start=0, stop=0):  # from project.project import *; plot_results()
